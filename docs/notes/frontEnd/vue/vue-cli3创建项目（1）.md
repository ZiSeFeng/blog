...
4. 浏览器打开显示:![在这里插入图片描述](../images/20190712144104146.png)
5. 点击创建
![在这里插入图片描述](../images/20190712144247576.png)
6. 手动配置项目
![在这里插入图片描述](../images/20190712144440398.png)
7. 选择功能，可以引入babel、TypeScript、Progressive Web App（PWA）Support、Router、Vuex等功能，具体看你项目的需要。
![在这里插入图片描述](../images/20190712144608958.png)
8. 选择好配置之后，点击创建项目就开始安装，到这步你就创建好一个新的项目。
项目的目录结构
![在这里插入图片描述](../images/20190712145155294.png)
### vue.config.js
```JavaScript
'use strict';
